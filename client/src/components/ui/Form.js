...
class Form extends Component {
  ...
  handSubmit(e){
    ...
    if(title.length==0 && category.length==0 && content.length==0){
      alert('nei rong bu neng shi kong')
      return;
    }
  ...
  render() {
    ...
    return (
      <form style={styles.form} onSubmit={this.handSubmit.bind(this)}>
        ...
        <div style={styles.div}>
          ...
          <textarea style={[styles.input, {height: '10vh'}]} rows='20' key='2' ref='content' />
        </div>
        <div style={styles.actions}>
          <button type='submit' style={styles.button}>click</button>
